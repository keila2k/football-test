...
export class MatchUtils {
  static getStandings(standings: StandingI[]): Array<StandingI[]> {
    return Object.values(groupBy(standings, (standing: StandingI) => standing.group));
  }

  static getMatches(standings: StandingI[]): Match[] {
